...
static tagMemDBTable	g_PGTableDictArray[]=
{
	...
	{	PG_ELECTROCHEMICALENERGYSTORAGE,	"ElectroChemicalEnergyStorage"		,	"", "电化学储能"			, 0	, sizeof(g_PGElectroChemicalEnergyStorageFieldArray)/sizeof(tagMemDBField)	, sizeof(tagPGElectroChemicalEnergyStorage)	, PG_MaxElectroChemicalEnergyStorage	, PGElectroChemicalEnergyStorage_Offset	,	{	3,	PG_ELECTROCHEMICALENERGYSTORAGE_SUBSTATION,	PG_ELECTROCHEMICALENERGYSTORAGE_VOLTAGELEVEL,	PG_ELECTROCHEMICALENERGYSTORAGE_NAME,		0,								},	g_PGElectroChemicalEnergyStorageFieldArray,},
	...
	{	PG_TRUNKSEGMENT,					"TrunkSegment"						,	"", "主干线"				, 0	, sizeof(g_PGTrunkSegmentFieldArray)				/sizeof(tagMemDBField)	, sizeof(tagPGTrunkSegment)					, PG_MaxTrunkSegment					, PGTrunkSegment_Offset					,	{	1,	PG_TRUNKSEGMENT_NAME,						PG_TRUNKSEGMENT_RESOURCEID,						0,											0,								},	g_PGTrunkSegmentFieldArray,				},
	{	PG_BRANCHSEGMENT,					"BranchSegment"						,	"", "分支线"				, 0	, sizeof(g_PGBranchSegmentFieldArray)				/sizeof(tagMemDBField)	, sizeof(tagPGBranchSegment)				, PG_MaxBranchSegment					, PGBranchSegment_Offset				,	{	0,	PG_BRANCHSEGMENT_RESOURCEID,				0,												0,											0,								},	g_PGBranchSegmentFieldArray,			},
																																																																				
	{	PG_DISTRIBUTIONSWITCH,				"DistributionSwitch"				,	"", "配电单元"				, 0	, sizeof(g_PGDistributionSwitchFieldArray)			/sizeof(tagMemDBField)	, sizeof(tagPGDistributionSwitch)			, PG_MaxDistributionSwitch				, PGDistributionSwitch_Offset			,	{	0,	PG_DISTRIBUTIONSWITCH_RESOURCEID,			0,												0,											0,								},	g_PGDistributionSwitchFieldArray,		},
	{	PG_DISTRIBUTIONLOAD,				"DistributionLoad"					,	"", "配电负荷"				, 0	, sizeof(g_PGDistributionLoadFieldArray)			/sizeof(tagMemDBField)	, sizeof(tagPGDistributionLoad)				, PG_MaxDistributionLoad				, PGDistributionLoad_Offset				,	{	0,	PG_DISTRIBUTIONLOAD_RESOURCEID,				0,												0,											0,								},	g_PGDistributionLoadFieldArray,			},
	{	PG_DISTRIBUTIONBREAKER,				"DistributionBreaker"				,	"", "配电开关"				, 0	, sizeof(g_PGDistributionBreakerFieldArray)			/sizeof(tagMemDBField)	, sizeof(tagPGDistributionBreaker)			, PG_MaxDistributionBreaker				, PGDistributionBreaker_Offset			,	{	0,	PG_DISTRIBUTIONBREAKER_RESOURCEID,			0,												0,											0,								},	g_PGDistributionBreakerFieldArray,		},
	{	PG_DISTRIBUTIONDOT,					"DistributionJuncPole"				,	"", "配电节点"				, 0	, sizeof(g_PGDistributionDotFieldArray)				/sizeof(tagMemDBField)	, sizeof(tagPGDistributionDot)				, PG_MaxDistributionDot					, PGDistributionDot_Offset				,	{	0,	PG_DISTRIBUTIONDOT_RESOURCEID,				0,												0,											0,								},	g_PGDistributionDotFieldArray,			},
																																																																				
	{	PG_WINDTURBINE,						"WindTurbine"						,	"", "风机"					, 0	, sizeof(g_PGWindTurbineFieldArray)					/sizeof(tagMemDBField)	, sizeof(tagPGWindTurbine)					, PG_MaxWindTurbine						, PGWindTurbine_Offset					,	{	0,	PG_WINDTURBINE_RESOURCEID,					0,												0,											0,								},	g_PGWindTurbineFieldArray,				},
	{	PG_PHOTOVOLTAIC,					"PhotoVoltaic"						,	"", "光伏"					, 0	, sizeof(g_PGPhotoVoltaicFieldArray)				/sizeof(tagMemDBField)	, sizeof(tagPGPhotoVoltaic)					, PG_MaxPhotoVoltaic					, PGPhotoVoltaic_Offset					,	{	0,	PG_PHOTOVOLTAIC_RESOURCEID,					0,												0,											0,								},	g_PGPhotoVoltaicFieldArray,				},
	{	PG_EVSTATION,						"EVStation"							,	"", "电动汽车充(换)电站"	, 0	, sizeof(g_PGEVStationFieldArray)					/sizeof(tagMemDBField)	, sizeof(tagPGEVStation)					, PG_MaxEVStation						, PGEVStation_Offset					,	{	0,	PG_EVSTATION_RESOURCEID,					0,												0,											0,								},	g_PGEVStationFieldArray,				},
																																																																				
	{	PG_CONNLINE,						"ConnLine"							,	"", "连接线"				, 0	, sizeof(g_PGConnLineFieldArray)					/sizeof(tagMemDBField)	, sizeof(tagPGConnLine)						, PG_MaxConnLine						, PGConnLine_Offset						,	{	0,	PG_CONNLINE_RESOURCEID,						0,												0,											0,								},	g_PGConnLineFieldArray					},
	{	PG_LANDPLOT,						"LandPlot"							,	"", "地块"					, 0	, sizeof(g_PGLandPlotFieldArray)					/sizeof(tagMemDBField)	, sizeof(tagPGLandPlot)						, PG_MaxLandPlot						, PGLandPlot_Offset						,	{	0,	PG_LANDPLOT_RESOURCEID,						0,												0,											0,								},	g_PGLandPlotFieldArray					},
	{	PG_PIPE,							"Pipe"								,	"", "电缆管线"				, 0	, sizeof(g_PGPipeFieldArray)						/sizeof(tagMemDBField)	, sizeof(tagPGPipe)							, PG_MaxPipe							, PGPipe_Offset							,	{	0,	PG_PIPE_RESOURCEID,							0,												0,											0,								},	g_PGPipeFieldArray						},
	{	PG_HYPERLINK,						"HyperLink"							,	"", "图形链接"				, 0	, sizeof(g_PGHyperLinkFieldArray)					/sizeof(tagMemDBField)	, sizeof(tagPGHyperLinks)					, PG_MaxHyperLinks						, PGHyperLinks_Offset					,	{	0,	PG_HYPERLINKS_RESOURCEID,					0,												0,											0,								},	g_PGHyperLinkFieldArray					},
...
static	tagMDBTableFieldContainer	g_PGTableFieldContainerArray[]=
{
	...
	{	MDBFieldCrit,	PG_TRANSFORMERWINDING,		PG_TRANSFORMERWINDING_SUBSTATION,		PG_TRANSFORMERWINDING_VOLTAGELEVELI,	-1,	-1,		PG_VOLTAGELEVEL,		},
	{	MDBFieldCrit,	PG_TRANSFORMERWINDING,		PG_TRANSFORMERWINDING_SUBSTATION,		PG_TRANSFORMERWINDING_VOLTAGELEVELJ,	-1,	-1,		PG_VOLTAGELEVEL,		},
	...
	{	MDBFieldWarn,	PG_TRANSFORMERWINDING,		PG_TRANSFORMERWINDING_TAPCHANGERZ,		-1,										-1,	-1,		PG_TAPCHANGER,			},
	{	MDBFieldCrit,	PG_RECTIFIERINVERTER,		PG_RECTIFIERINVERTER_SUBSTATION,		-1,										-1,	-1,		PG_SUBSTATION,			},
	{	MDBFieldCrit,	PG_RECTIFIERINVERTER,		PG_RECTIFIERINVERTER_SUBSTATION,		PG_RECTIFIERINVERTER_VOLTAGELEVEL1,		-1,	-1,		PG_VOLTAGELEVEL,		},
	{	MDBFieldCrit,	PG_RECTIFIERINVERTER,		PG_RECTIFIERINVERTER_SUBSTATION,		PG_RECTIFIERINVERTER_VOLTAGELEVEL2,		-1,	-1,		PG_VOLTAGELEVEL,		},
	{	MDBFieldCrit,	PG_RECTIFIERINVERTER,		PG_RECTIFIERINVERTER_SUBSTATION,		PG_RECTIFIERINVERTER_VOLTAGELEVEL3,		-1,	-1,		PG_VOLTAGELEVEL,		},
