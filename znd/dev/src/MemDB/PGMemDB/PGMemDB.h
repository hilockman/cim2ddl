...
namespace	PGMemDB
{
	...
	PGMEMDB_EXPORTS	const int	PGIsFieldPrimaryKey(const int nTable, const int nField);
	...
	PGMEMDB_EXPORTS	int		PGIsTranMidNode(tagPGBlock* pPGBlock, const int nJudgeNode);
	PGMEMDB_EXPORTS	int		PGGetTranRatio(tagPGBlock* pPGBlock, const int nTran, float& fTapRatio);
	PGMEMDB_EXPORTS	void	PGGetParallelLine(tagPGBlock* pPGBlock, const int nLine, const unsigned char bCheckStatus, int& nParaLineNum, int nParaLineArray[]);
	PGMEMDB_EXPORTS	void	PGGetParallelWind(tagPGBlock* pPGBlock, const int nTran, const unsigned char bCheckStatus, int& nParaWindNum, int nParaWindArray[]);
	...
	PGMEMDB_EXPORTS	void	PGTraverseTopo(tagPGBlock* pPGBlock, const int nStartNode, const int bChkBreakerOpen, const int bChkSwitchOpen, const int bInBus, const int bChkBreak,  int& nNodeNum, int nNodeArray[]);
	...
	PGMEMDB_EXPORTS	const int	PGGetFieldCategoryNum();
	PGMEMDB_EXPORTS	const char*	PGGetFieldCategoryName(const int nCatrgory);
	PGMEMDB_EXPORTS	const int	PGGetFieldCategoryValue(const char* lpszCatrgory);

	PGMEMDB_EXPORTS	const int	PGGetTableFieldContainerNum();
