...
static tagMemDBField	g_PRSystemFieldArray[]=
{
	...
	{	PR_SYSTEM_GENP,					"GenP",					"系统总发电(兆瓦)",					MDBFieldCategoryOutput,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	{	PR_SYSTEM_LOADP,				"LoadP",				"系统总负荷(兆瓦)",					MDBFieldCategoryOutput,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	{	PR_SYSTEM_DCP,					"DCP",					"系统直流容量(兆瓦)",				MDBFieldCategoryOutput,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	{	PR_SYSTEM_AVAILGENP,			"AvailGenP",			"系统总装机(兆瓦)",					MDBFieldCategoryOutput,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	{	PR_SYSTEM_MAXLOADP,				"MaxLoadP",				"系统最大负荷(兆瓦)",				MDBFieldCategoryOutput,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	...
	{	PR_SYSTEM_ELC,					"ELC",					"负荷切除期望值(兆瓦/年)",			MDBFieldCategoryOutput,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	{	PR_SYSTEM_EENS,					"EENS",					"电量不足期望值(兆瓦时/年)",		MDBFieldCategoryOutput,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	{	PR_SYSTEM_BPII,					"BPII",					"系统停电指标(兆瓦/兆瓦.年)",		MDBFieldCategoryOutput,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	{	PR_SYSTEM_BPECI,				"BPECI",				"系统削减电量指标(兆瓦时/兆瓦.年)",	MDBFieldCategoryOutput,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	...
	{	PR_SYSTEM_MIEENS,				"MIslandEENS",			"孤岛电量不足期望值(兆瓦时/年)",	MDBFieldCategoryOutput,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	{	PR_SYSTEM_AGCEENS,				"LossGenEENS",			"失电电量不足期望值(兆瓦时/年)",	MDBFieldCategoryOutput,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	{	PR_SYSTEM_ELEENS,				"ERlimitEENS",			"消限电量不足期望值(兆瓦时/年)",	MDBFieldCategoryOutput,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
...
static tagMemDBField	g_PRRadFieldArray[]=
{
	...
	{	PR_RADIAL_RINGKV,				"RingkV",				"环网(环辐边界)母线电压(千伏)",	MDBFieldCategoryBase,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	{	PR_RADIAL_LOADP,				"LoadP",				"辐射网内负荷(兆瓦)",			MDBFieldCategoryBase,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
...
static tagMemDBField	g_PRACBusFieldArray[]=
{
	...
	{	PR_ACBUS_KV,					"kV",				"计算平均电压(千伏)",				MDBFieldCategoryBase,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_ACBUS_ZONE,					"Zone",				"分区",								MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_SHORTEST,	0,	NULL,	},
	{	PR_ACBUS_GENP,					"GenP",				"母线发电有功(兆瓦)",				MDBFieldCategoryParam,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	{	PR_ACBUS_GENQ,					"GenQ",				"母线发电无功(兆乏)",				MDBFieldCategoryParam,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	{	PR_ACBUS_LOADP,					"LoadP",			"母线负荷有功(兆瓦)",				MDBFieldCategoryParam,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	{	PR_ACBUS_LOADQ,					"LoadQ",			"母线负荷无功(兆乏)",				MDBFieldCategoryParam,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	{	PR_ACBUS_RADP,					"RadP",				"辐射网等效负荷(兆瓦)",				MDBFieldCategoryParam,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	{	PR_ACBUS_SHUNTQ,				"ShuntQ",			"母线补偿无功(兆乏)",				MDBFieldCategoryParam,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	...
	{	PR_ACBUS_ADGENP,				"AdGenP",			"发电机调节量(兆瓦)",				MDBFieldCategoryAid,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	{	PR_ACBUS_ADLOADP,				"AdLoadP",			"负荷调节量(兆瓦)",					MDBFieldCategoryAid,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	{	PR_ACBUS_ADRADP,				"AdRadP",			"辐射网等效负荷调节量(兆瓦)",		MDBFieldCategoryAid,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	...
	{	PR_ACBUS_FAULTFREQ,				"FaultFreq",		"故障次数(次)",						MDBFieldCategoryOutput,	MDB_INT,	sizeof(int),			0,	NULL,	},
	{	PR_ACBUS_RTV,					"RtV",				"电压计算结果(千伏)",				MDBFieldCategoryOutput,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	{	PR_ACBUS_PFD,					"PfD",				"功角计算结果(度)",					MDBFieldCategoryOutput,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	...
	{	PR_ACBUS_ELC,					"ELC",				"负荷切除期望值(兆瓦/年)",			MDBFieldCategoryOutput,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	{	PR_ACBUS_EENS,					"EENS",				"电量不足期望值(兆瓦时/年)",		MDBFieldCategoryOutput,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	{	PR_ACBUS_BPII,					"BPECI",			"系统削减电量指标(兆瓦时/兆瓦.年)",	MDBFieldCategoryOutput,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	{	PR_ACBUS_BPECI,					"BPII",				"系统停电指标(兆瓦/兆瓦.年)",		MDBFieldCategoryOutput,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	...
	{	PR_ACBUS_GENPMAX,				"GenPMax",			"母线所接发电机容量上限(兆瓦)",		MDBFieldCategoryAid,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	{	PR_ACBUS_GENPMIN,				"GenPMin",			"母线所接发电机容量下限(兆瓦)",		MDBFieldCategoryAid,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	{	PR_ACBUS_LOADPMIN,				"LoadPMin",			"母线所接负荷功率下限(兆瓦)",		MDBFieldCategoryAid,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	...
	{	PR_ACBUS_OUTAGE,				"Outage",			"停运",								MDBFieldCategoryAid,	MDB_BIT,	sizeof(unsigned char),	0,	NULL,	},
};
...
static tagMemDBField	g_PRACLineFieldArray[]=
{
	...
	{	PR_ACLINE_KVI,					"kVI",				"I侧电压(千伏)",					MDBFieldCategoryBase,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_ACLINE_KVJ,					"kVJ",				"J侧电压(千伏)",					MDBFieldCategoryBase,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_ACLINE_PARID,				"ParlId",			"并联回路号",						MDBFieldCategoryBase,	MDB_CHAR,	sizeof(char),			0,	NULL,	},
	{	PR_ACLINE_R,					"R",				"电阻(标幺)",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_ACLINE_X,					"X",				"电抗(标幺)",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_ACLINE_B,					"B",				"电纳(标幺)",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_ACLINE_RATED,				"Rated",			"额定容量(兆瓦)",					MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_ACLINE_LENGTH,				"Length",			"长度(千米)",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	...
	{	PR_ACLINE_OLMTVALUE,			"OLmtValue",		"越限功率(兆瓦/次)",				MDBFieldCategoryOutput,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	{	PR_ACLINE_ELMTCUTLOAD,			"ELmtCutLoad",		"消限切负荷电量(兆瓦时/年)",		MDBFieldCategoryOutput,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	{	PR_ACLINE_RTPI,					"RtPi",				"RT起点有功(兆瓦)",					MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_ACLINE_RTQI,					"RtQi",				"RT起点无功(兆乏)",					MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_ACLINE_RTPZ,					"RtPz",				"RT终点有功(兆瓦)",					MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_ACLINE_RTQZ,					"RtQz",				"RT终点无功(兆乏)",					MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_ACLINE_LOSSP,				"LossP",			"损耗(兆瓦)",						MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_ACLINE_PFPI,					"PfPi",				"PF起点有功(兆瓦)",					MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_ACLINE_PFQI,					"PfQi",				"PF起点无功(兆乏)",					MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_ACLINE_PFPZ,					"PfPz",				"PF终点有功(兆瓦)",					MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_ACLINE_PFQZ,					"PfQz",				"PF终点无功(兆乏)",					MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_ACLINE_TRPI,					"TrPi",				"TR起点有功(兆瓦)",					MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_ACLINE_TRQI,					"TrQi",				"TR起点无功(兆乏)",					MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_ACLINE_TRPZ,					"TrPz",				"TR终点有功(兆瓦)",					MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_ACLINE_TRQZ,					"TrQz",				"TR终点无功(兆乏)",					MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	...
	{	PR_ACLINE_INIKVI,				"InikVI",			"Ini起点侧电压(千伏)",				MDBFieldCategoryAid,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_ACLINE_INIKVJ,				"InikVJ",			"Ini终点侧电压(千伏)",				MDBFieldCategoryAid,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
...
static tagMemDBField	g_PRWindFieldArray[]=
{
	...
	{	PR_WIND_KVI,				"kVI",				"I侧电压(千伏)",					MDBFieldCategoryBase,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_WIND_KVJ,				"kVJ",				"J侧电压(千伏)",					MDBFieldCategoryBase,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_WIND_PARID,				"ParlId",			"并联回路号",						MDBFieldCategoryBase,	MDB_CHAR,	sizeof(char),			0,	NULL,	},
	{	PR_WIND_R,					"R",				"电阻(标幺)",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_WIND_X,					"X",				"电抗(标幺)",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_WIND_RATED,				"Rated",			"额定容量(兆瓦)",					MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	...
	{	PR_WIND_OLMTVALUE,			"OLmtValue",		"越限功率(兆瓦/次)",				MDBFieldCategoryOutput,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	{	PR_WIND_ELMTCUTLOAD,		"ELmtCutLoad",		"消限切负荷电量(兆瓦时/年)",		MDBFieldCategoryOutput,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	{	PR_WIND_RTPI,				"RtPi",				"RT起点有功(兆瓦)",					MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_WIND_RTQI,				"RtQi",				"RT起点无功(兆乏)",					MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_WIND_RTPZ,				"RtPz",				"RT终点有功(兆瓦)",					MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_WIND_RTQZ,				"RtQz",				"RT终点无功(兆乏)",					MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_WIND_LOSSP,				"LossP",			"损耗(兆瓦)",						MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_WIND_PFPI,				"PfPi",				"PF起点有功(兆瓦)",					MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_WIND_PFQI,				"PfQi",				"PF起点无功(兆乏)",					MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_WIND_PFPZ,				"PfPz",				"PF终点有功(兆瓦)",					MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_WIND_PFQZ,				"PfQz",				"PF终点无功(兆乏)",					MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_WIND_TRPI,				"TrPi",				"TR起点有功(兆瓦)",					MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_WIND_TRQI,				"TrQi",				"TR起点无功(兆乏)",					MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_WIND_TRPZ,				"TrPz",				"TR终点有功(兆瓦)",					MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_WIND_TRQZ,				"TrQz",				"TR终点无功(兆乏)",					MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	...
	{	PR_WIND_INIKVI,				"InikVI",			"Ini起点侧电压(千伏)",				MDBFieldCategoryAid,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_WIND_INIKVJ,				"InikVJ",			"Ini终点侧电压(千伏)",				MDBFieldCategoryAid,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
...
static tagMemDBField	g_PRGeneratorFieldArray[]=
{
	...
	{	PR_GENERATOR_BUSKV,			"BuskV",			"电压(千伏)",						MDBFieldCategoryBase,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	...
	{	PR_GENERATOR_P,				"P",				"有功(兆瓦)",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_GENERATOR_Q,				"Q",				"无功(兆乏)",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_GENERATOR_PMAX,			"PMax",				"最大有功(兆瓦)",					MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_GENERATOR_PMIN,			"PMin",				"最小有功(兆瓦)",					MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_GENERATOR_QMAX,			"QMax",				"最大无功(兆乏)",					MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_GENERATOR_QMIN,			"QMin",				"最小无功(兆乏)",					MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	...
	{	PR_GENERATOR_REFP,			"ReferenceP",		"给定有功(兆瓦)",					MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_GENERATOR_REFQ,			"ReferenceQ",		"给定无功(兆乏)",					MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
...
static tagMemDBField	g_PRPowerLoadFieldArray[]=
{
	...
	{	PR_POWERLOAD_BUSKV,			"BuskV",			"电压(千伏)",						MDBFieldCategoryBase,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_POWERLOAD_ZONE,			"Zone",				"分区",								MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_SHORTEST,	0,	NULL,	},
	{	PR_POWERLOAD_P,				"P",				"有功(兆瓦)",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_POWERLOAD_Q,				"Q",				"无功(兆乏)",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_POWERLOAD_PMAX,			"PMax",				"最大有功(兆瓦)",					MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	...
	{	PR_POWERLOAD_MSPOUT,		"MSPout",			"多状态功率(兆瓦)",					MDBFieldCategoryParam,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	{	PR_POWERLOAD_REFP,			"ReferenceP",		"给定有功(兆瓦)",					MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_POWERLOAD_REFQ,			"ReferenceQ",		"给定无功(兆乏)",					MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
...
static tagMemDBField	g_PRHVDCFieldArray[]=
{
	...
	{	PR_HVDC_KVR,			"kVR",				"整流侧电压(千伏)",					MDBFieldCategoryBase,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_HVDC_KVI,			"kVI",				"逆变侧电压(千伏)",					MDBFieldCategoryBase,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	...
	{	PR_HVDC_RATEDC,			"RatedC",			"额定电流(安)",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_HVDC_RECTV,			"RectV",			"整流侧直流电压(千伏)",				MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_HVDC_RATEDP,			"RatedP",			"额定功率(兆瓦)",					MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_HVDC_LENGTH,			"Length",			"长度(千米)",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_HVDC_POWER,			"Power",			"安排的直流功率(兆瓦)",				MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_HVDC_PWRR,			"PwrR",				"整流侧功率(兆瓦)",					MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_HVDC_PWRI,			"PwrI",				"逆变侧功率(兆瓦)",					MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_HVDC_LOSSP,			"LossP",			"损耗(兆瓦)",						MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	...
	{	PR_HVDC_INIPWRR,		"IniPwrR",			"Ini整流侧功率(兆瓦)",				MDBFieldCategoryAid,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_HVDC_INIPWRI,		"IniPwrI",			"Ini逆变侧功率(兆瓦)",				MDBFieldCategoryAid,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	...
	{	PR_HVDC_ISLANDR,		"ACIslandR",		"整流侧交流电岛",					MDBFieldCategoryAid,	MDB_SHORT,	sizeof(short),			0,	NULL,	},
	{	PR_HVDC_ISLANDI,		"ACIslandI",		"逆变侧交流电岛",					MDBFieldCategoryAid,	MDB_SHORT,	sizeof(short),			0,	NULL,	},
	{	PR_HVDC_SERIALNO,		"SerialNo",			"直流索引",							MDBFieldCategoryAid,	MDB_INT,	sizeof(int),			0,	NULL,	},
	{	PR_HVDC_RPARAMTYPE,		"RParamType",		"可靠性参数类型",					MDBFieldCategoryAid,	MDB_BIT,	sizeof(unsigned char),	sizeof(g_PRDeviceRParamTypeEnum)/sizeof(tagMemDBEnumPair),	g_PRDeviceRParamTypeEnum,	},
...
static tagMemDBField	g_PRConverterFieldArray[]=
{
	...
	{	PR_CONVERTER_SCHEDPOWER,		"SchedPower",		"安排的功率(兆瓦)",					MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
...
static tagMemDBField	g_PRDCLineFieldArray[]=
{
	...
	{	PR_DCLINE_LENGTH,				"Length",			"长度(千米)",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
...
static tagMemDBField	g_PRTCSCFieldArray[]=
{
	...
	{	PR_TCSC_X,						"X",				"串联电抗值(标幺)",					MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
...
static tagMemDBField	g_PRUPFCFieldArray[]=
{
	...
	{	PR_UPFC_CAPACITY,				"Capacity",			"容量(兆伏安)",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	...
	{	PR_UPFC_LINEPSE,				"LinePse",			"串联侧注入功率(兆瓦)",				MDBFieldCategoryAid,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_UPFC_P,						"P",				"串联侧控制功率(兆瓦)",				MDBFieldCategoryAid,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
...
static tagMemDBField	g_PRLoadCurveFieldArray[]=
{
	...
	{	PR_LOADCURVE_VALDAY,			"ValDay",			"曲线点日值(兆瓦)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_LOADCURVE_VALAVER,			"ValAver",			"曲线点均值(兆瓦)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_LOADCURVE_VALMAX,			"ValMax",			"曲线点大值(兆瓦)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_LOADCURVE_VALMIN,			"ValMin",			"曲线点小值(兆瓦)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},

	{	PR_LOADCURVE_VALUE01,			"Value01",			"曲线点01值(兆瓦)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_LOADCURVE_VALUE02,			"Value02",			"曲线点02值(兆瓦)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_LOADCURVE_VALUE03,			"Value03",			"曲线点03值(兆瓦)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_LOADCURVE_VALUE04,			"Value04",			"曲线点04值(兆瓦)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_LOADCURVE_VALUE05,			"Value05",			"曲线点05值(兆瓦)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_LOADCURVE_VALUE06,			"Value06",			"曲线点06值(兆瓦)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_LOADCURVE_VALUE07,			"Value07",			"曲线点07值(兆瓦)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_LOADCURVE_VALUE08,			"Value08",			"曲线点08值(兆瓦)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_LOADCURVE_VALUE09,			"Value09",			"曲线点09值(兆瓦)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_LOADCURVE_VALUE10,			"Value10",			"曲线点10值(兆瓦)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_LOADCURVE_VALUE11,			"Value11",			"曲线点11值(兆瓦)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_LOADCURVE_VALUE12,			"Value12",			"曲线点12值(兆瓦)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_LOADCURVE_VALUE13,			"Value13",			"曲线点13值(兆瓦)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_LOADCURVE_VALUE14,			"Value14",			"曲线点14值(兆瓦)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_LOADCURVE_VALUE15,			"Value15",			"曲线点15值(兆瓦)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_LOADCURVE_VALUE16,			"Value16",			"曲线点16值(兆瓦)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_LOADCURVE_VALUE17,			"Value17",			"曲线点17值(兆瓦)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_LOADCURVE_VALUE18,			"Value18",			"曲线点18值(兆瓦)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_LOADCURVE_VALUE19,			"Value19",			"曲线点19值(兆瓦)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_LOADCURVE_VALUE20,			"Value20",			"曲线点20值(兆瓦)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_LOADCURVE_VALUE21,			"Value21",			"曲线点21值(兆瓦)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_LOADCURVE_VALUE22,			"Value22",			"曲线点22值(兆瓦)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_LOADCURVE_VALUE23,			"Value23",			"曲线点23值(兆瓦)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_LOADCURVE_VALUE24,			"Value24",			"曲线点24值(兆瓦)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
};

static tagMemDBField	g_PRACIslandFieldArray[]=
{
	{	PR_ACISLAND_GENP,				"GenP",				"岛发电(兆瓦)",						MDBFieldCategoryBase,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	{	PR_ACISLAND_LOADP,				"LoadP",			"岛负荷(兆瓦)",						MDBFieldCategoryBase,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	{	PR_ACISLAND_HVDCP,				"HVDCP",			"直流功率(兆瓦)",					MDBFieldCategoryBase,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
...
static tagMemDBField	g_PRZoneFieldArray[]=
{
	...
	{	PR_ZONE_TOTGENP,				"TotalGenP",		"分区发电(兆瓦)",					MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_ZONE_TOTLOADP,				"TotalLoadP",		"分区负荷(兆瓦)",					MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_ZONE_CUTLOADP,				"FCutLoadP",		"分区事故切负荷(兆瓦)",				MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
};
...
static tagMemDBField	g_PRACLineEdgeFieldArray[]=
{
	...
	{	PR_ACLINEEDGE_KV,				"kV",				"母线电压(千伏)",					MDBFieldCategoryBase,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
...
static tagMemDBField	g_PRWindEdgeFieldArray[]=
{
	...
	{	PR_WINDEDGE_KV,					"kV",				"母线电压(千伏)",					MDBFieldCategoryBase,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
...
static tagMemDBField	g_PRTripMIslandFieldArray[]=
{
	...
	{	PR_TRIPMISLAND_OUTAGELOADP,		"OutageLoadP",		"孤岛负荷功率(兆瓦)",				MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
};
...
static tagMemDBField	g_PRTripOvlDevFieldArray[]=
{
	...
	{	PR_TRIPOVLDEV_OVLVAL,			"OvLmtValue",		"越限值(兆瓦)",						MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_TRIPOVLDEV_RATED,			"Rated",			"额定值(兆瓦)",						MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
};
...
static tagMemDBField	g_PRFStateFieldArray[]=
{
	...
	{	PR_FSTATE_FLOSSGEN,				"FLossGen",			"故障损失发电机出力(兆瓦)",			MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_FSTATE_FLOSSGENCAP,			"FLossGenCap",		"故障损失发电机容量(兆瓦)",			MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_FSTATE_FLOSSLOAD,			"FLossLoad",		"故障损失负荷功率(兆瓦)",			MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	...
	{	PR_FSTATE_MIINSGEN,				"MIslandInsGen",	"孤岛增加出力(兆瓦)",				MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_FSTATE_MICUTGEN,				"MIslandCutGen",	"孤岛减少出力(兆瓦)",				MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_FSTATE_MICUTLOAD,			"MIslandOutLoad",	"孤岛损失负荷(兆瓦)",				MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_FSTATE_AGCINSGEN,			"BalanceInsGen",	"功率平衡发电机增出力(兆瓦)",		MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_FSTATE_AGCCUTGEN,			"BalanceCutGen",	"功率平衡发电机减出力(兆瓦)",		MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_FSTATE_AGCCUTLOAD,			"BalanceCutLoad",	"功率平衡损失负荷(兆瓦)",			MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	...
	{	PR_FSTATE_ELCUTGEN,				"ELimitCutGen",		"消限减少出力(兆瓦)",				MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_FSTATE_ELINSGEN,				"ELimitInsGen",		"消限增加出力(兆瓦)",				MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_FSTATE_ELCUTLOAD,			"ELimitCutLoad",	"消限损失负荷(兆瓦)",				MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
...
static tagMemDBField	g_PRFStateMIslandFieldArray[]=
{
	...
	{	PR_FSTATEMISLAND_OUTAGELOADP,	"OutageLoadP",		"孤岛负荷功率(兆瓦)",				MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
};
...
static tagMemDBField	g_PRFStateOvlDevFieldArray[]=
{
	...
	{	PR_FSTATEOVLDEV_OVLMTP,			"OvLmtP",			"越限值(兆瓦)",						MDBFieldCategoryBase,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_FSTATEOVLDEV_RATED,			"Rated",			"额定值(兆瓦)",						MDBFieldCategoryBase,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	PR_FSTATEOVLDEV_ADLMTP,			"AdLmtP",			"消限值(兆瓦)",						MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
};
...
static tagMemDBField	g_PRFStateOvlAdFieldArray[]=
{
	...
	{	PR_FSTATEOVLAD_ADJVALUE,		"AdjValue",			"功率调整量(兆瓦)",					MDBFieldCategoryOutput,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
};
...
static tagMemDBField	g_PRFSecurityFieldArray[]=
{
	...
	{	PR_FSECURITY_LOSSGENP,			"LossGenP",			"发电出力损失(兆瓦)",				MDBFieldCategoryBase,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
...
static tagMemDBField	g_PRCopGenFieldArray[]=
{
	...
	{	PR_COPGEN_CAPACITY,				"Capacity",			"发电机容量(兆瓦)",					MDBFieldCategoryBase,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	{	PR_COPGEN_ALPHA,				"Alpha",			"折算系数",							MDBFieldCategoryBase,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	{	PR_COPGEN_S1CAPACITY,			"S1Capacity",		"发电机折算容量1(兆瓦)",			MDBFieldCategoryBase,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	{	PR_COPGEN_S2CAPACITY,			"S2Capacity",		"发电机折算容量2(兆瓦)",			MDBFieldCategoryBase,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
...
static tagMemDBField	g_PRCopTableFieldArray[]=
{
	...
	{	PR_COPTABLE_OUTAGECAPACITY,		"OutageCapacity",	"停运发电容量(兆瓦)",				MDBFieldCategoryOutput,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
	{	PR_COPTABLE_AVAILCAPACITY,		"AvailCapacity",	"可用发电容量(兆瓦)",				MDBFieldCategoryOutput,	MDB_DOUBLE,	sizeof(double),			0,	NULL,	},
