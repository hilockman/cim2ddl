...
{
	{	BPA_DAT_SUB_NAME,	"Sub_Name",		"厂站名称",			MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_SHORTER,	0,	NULL,	},
...
static	tagMemDBField	dicFieldBpaDat_ACBus[]=
{
	...
	{	BPA_DAT_ACBUS_ADDPLOAD,		"ACBus_AddPLoad",		"延续节点有功负荷(MW)",					MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_DAT_ACBUS_ADDQLOAD,		"ACBus_AddQLoad",		"延续节点无功负荷(MVAR),+感性",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_DAT_ACBUS_ADDPSHUNT,	"ACBus_AddPShunt",		"延续节点并联有功负荷(MW)",				MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_DAT_ACBUS_ADDQSHUNT,	"ACBus_AddQShunt",		"延续节点并联无功负荷(MVAR),+容性",		MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	...
	{	BPA_DAT_ACBUS_SUB,			"ACBus_BpaSub",			"母线所属BPA厂站",						MDBFieldCategoryAid,	MDB_STRING,	MDB_CHARLEN_SHORTER,	0,	NULL,	},
	...
	{	BPA_DAT_ACBUS_INIADDPLOAD,	"ACBus_IniAddPLoad",	"Ini延续节点有功负荷(MW)",				MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_DAT_ACBUS_INIADDQLOAD,	"ACBus_IniAddQLoad",	"Ini延续节点无功负荷(MVAR),+感性",		MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_DAT_ACBUS_INIADDPSHUNT,	"ACBus_IniAddPShunt",	"Ini延续节点并联有功负荷(MW)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_DAT_ACBUS_INIADDQSHUNT,	"ACBus_IniAddQShunt",	"Ini延续节点并联无功负荷(MVAR),+容性",	MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_DAT_ACBUS_INIADDPGEN,	"ACBus_IniAddPGen",		"Ini延续节点有功出力(MW)",				MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_DAT_ACBUS_INIADDQGEN,	"ACBus_IniAddQGen",		"Ini延续节点无功出力(MVAR),+感性",		MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	...
	{	BPA_DAT_ACBUS_DCBOUND,		"DCBound",				"交直流边界交流母线",					MDBFieldCategoryAid,	MDB_BIT,	sizeof(unsigned	char),	0,	NULL,	},
	...
	{	BPA_DAT_ACBUS_REDUCTION,	"Reduction",			"化简等值母线",							MDBFieldCategoryAid,	MDB_BIT,	sizeof(unsigned	char),	0,	NULL,	},
...
static	tagMemDBField	dicFieldBpaDat_Wind[]=
{
	...
	{	BPA_DAT_WIND_BUSIPTR,	"BusIPtr",		"变压器I母线索引",							MDBFieldCategoryAid,	MDB_INT,	sizeof(int),			0,	NULL,	},
	{	BPA_DAT_WIND_BUSJPTR,	"BusJPtr",		"变压器J母线索引",							MDBFieldCategoryAid,	MDB_INT,	sizeof(int),			0,	NULL,	},
	...
	{	BPA_DAT_WIND_TRANPTR,	"TranPtr",		"变压器索引",								MDBFieldCategoryAid,	MDB_INT,	sizeof(int),			0,	NULL,	},
...
static	tagMemDBField	dicFieldBpaDat_DCBus[]=
{
	...
	{	BPA_DAT_DCBUS_PRLINE,		"pRLine",				"母线线路索引",						MDBFieldCategoryAid,	MDB_INT,	sizeof(int),			0,	NULL,	},
	{	BPA_DAT_DCBUS_PRTRAN,		"pRTran",				"母线变压器索引",					MDBFieldCategoryAid,	MDB_INT,	sizeof(int),			0,	NULL,	},
...
static	tagMemDBField	dicFieldBpaDat_DCLine[]=
{
	...
	{	BPA_DAT_DCLINE_MILES,	"DCLine_Miles",		"线路长度",							MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
...
static	tagMemDBField	dicFieldBpaDat_P[]=
{
	...
	{	BPA_DAT_P_INILOADPFACTOR,	"P_IniLoadPFactor",	"Ini负荷有功修改因子",		MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),				0,	NULL,	},
	{	BPA_DAT_P_INILOADQFACTOR,	"P_IniLoadQFactor",	"Ini负荷无功修改因子",		MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),				0,	NULL,	},
	{	BPA_DAT_P_INIGENPFACTOR,	"P_IniGenPFactor",	"Ini发电出力有功修改因子",	MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),				0,	NULL,	},
	{	BPA_DAT_P_INIGENQFACTOR,	"P_IniGenQFactor",	"Ini发电出力无功修改因子",	MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),				0,	NULL,	},
...
static	tagMemDBField	dicFieldBpaDat_ZIL[]=
{
	...
	{	BPA_DAT_ZIL_KEYNAME,	"KeyName",			"小支路名称",				MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_SHORT,		0,	NULL,	},
};
...
static	tagMemDBField	dicFieldBpaDat_Gen[]=
{
	...
	{	BPA_DAT_GEN_WTGEN,			"Gen_WTGen",		"风电机组",				MDBFieldCategoryAid,	MDB_BIT,	sizeof(unsigned	char),	0,	NULL,	},
	{	BPA_DAT_GEN_PVGEN,			"Gen_PVGen",		"光伏模型",				MDBFieldCategoryAid,	MDB_BIT,	sizeof(unsigned	char),	0,	NULL,	},
...
static	tagMemDBField	dicFieldBpaDat_Tran[]=
{
	...
	{	BPA_DAT_TRAN_STATUS,		"Status",			"状态",					MDBFieldCategoryAid,	MDB_BIT,	sizeof(unsigned	char),	0,	NULL,	},
};

static	tagMemDBField	dicFieldBpaDat_EdgeACLine[]=
{
	{	BPA_DAT_EDGEACLINE_ACBUSNAME,	"ACBusName",	"交流母线名称",		MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_BPABUS,		0,	NULL,	},
	{	BPA_DAT_EDGEACLINE_ACBUSKV,		"ACBuskV",		"交流母线电压(kV)",	MDBFieldCategoryBase,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_DAT_EDGEACLINE_ACLINENAME,	"ACLineName",	"交流线路名称",		MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_SHORT,		0,	NULL,	},
	{	BPA_DAT_EDGEACLINE_ACLINEPTR,	"ACLinePtr",	"交流线路索引",		MDBFieldCategoryBase,	MDB_INT,	sizeof(int),			0,	NULL,	},
};

static	tagMemDBField	dicFieldBpaDat_EdgeWind[]=
{
	{	BPA_DAT_EDGEWIND_ACBUSNAME,		"ACBusName",	"交流母线名称",		MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_BPABUS,		0,	NULL,	},
	{	BPA_DAT_EDGEWIND_ACBUSKV,		"ACBuskV",		"交流母线电压(kV)",	MDBFieldCategoryBase,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_DAT_EDGEWIND_WINDNAME,		"WindName",		"变压器绕组名称",	MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_SHORT,		0,	NULL,	},
	{	BPA_DAT_EDGEWIND_WINDPTR,		"WindPtr",		"变压器绕组索引",	MDBFieldCategoryBase,	MDB_INT,	sizeof(int),			0,	NULL,	},
};

static	tagMemDBField	dicFieldBpaDat_EdgeLineHG[]=
{
	{	BPA_DAT_EDGELINEHG_ACBUSNAME,	"ACBusName",	"交流母线名称",		MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_BPABUS,		0,	NULL,	},
	{	BPA_DAT_EDGELINEHG_ACBUSKV,		"ACBuskV",		"交流母线电压(kV)",	MDBFieldCategoryBase,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_DAT_EDGELINEHG_HGNAME,		"LineHGName",	"线路高抗名称",		MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_SHORT,		0,	NULL,	},
	{	BPA_DAT_EDGELINEHG_LINEHGPTR,	"LineHGPtr",	"线路高抗索引",		MDBFieldCategoryBase,	MDB_SHORT,	sizeof(short),			0,	NULL,	},
};

static	tagMemDBField	dicFieldBpaDat_EdgeDCLine[]=
{
	{	BPA_DAT_EDGEDCLINE_DCBUSNAME,	"DCBusName",	"直流母线名称",		MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_BPABUS,		0,	NULL,	},
	{	BPA_DAT_EDGEDCLINE_DCBUSKV,		"DCBuskV",		"直流母线电压(kV)",	MDBFieldCategoryBase,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_DAT_EDGEDCLINE_DCLINENAME,	"DCLineName",	"直流线路名称",		MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_SHORT,		0,	NULL,	},
	{	BPA_DAT_EDGEDCLINE_DCLINEPTR,	"DCLinePtr",	"直流线路索引",		MDBFieldCategoryBase,	MDB_INT,	sizeof(int),			0,	NULL,	},
};

static	tagMemDBField	dicFieldBpaDat_EdgeR[]=
{
	{	BPA_DAT_EDGER_DCBUSNAME,		"DCBusName",	"直流母线名称",		MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_BPABUS,		0,	NULL,	},
	{	BPA_DAT_EDGER_DCBUSKV,			"DCBuskV",		"直流母线电压(kV)",	MDBFieldCategoryBase,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_DAT_EDGER_RNAME,			"WindName",		"调压器名称",		MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_SHORT,		0,	NULL,	},
	{	BPA_DAT_EDGER_RPTR,				"WindPtr",		"调压器索引",		MDBFieldCategoryBase,	MDB_INT,	sizeof(int),			0,	NULL,	},
};
...
{
	{	BPA_SWI_WGWGEN_CARDKEY,		"CardKey",		"卡类型",												MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_BPABUS,		0,	NULL,	},
	{	BPA_SWI_WGWGEN_BUS_NAME,	"ACBus_Name",	"电机母线名",											MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_BPABUS,		0,	NULL,	},
	{	BPA_SWI_WGWGEN_BUS_KV,		"ACBus_kV",		"电机母线电压(kV)",										MDBFieldCategoryBase,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_WGWGEN_ID,			"Gen_ID",		"电机识别码",											MDBFieldCategoryBase,	MDB_CHAR,	sizeof(char),			0,	NULL,	},
	{	BPA_SWI_WGWGEN_GW_TYPE,		"GW_TYPE",		"风电机组类型代码",										MDBFieldCategoryParam,	MDB_STRING,	MDB_CHARLEN_SHORT,		0,	NULL,	},
	{	BPA_SWI_WGWGEN_NG,			"NG",			"风电机组台数",											MDBFieldCategoryParam,	MDB_SHORT,	sizeof(short),			0,	NULL,	},
	{	BPA_SWI_WGWGEN_PPER,		"PPER",			"有功占潮流总出力比例",									MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_WGWGEN_QPER,		"QPER",			"无功占潮流总出力比例",									MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_WGWGEN_IP_CUR,		"IP_CUR",		"低电压穿越,有功电流设定值(A,缺省200)",					MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_WGWGEN_IP_RETURN,	"IP_RETURN",	"低电压穿越恢复,有功电流设定值(A,缺省400)",				MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_WGWGEN_IP_RET_TIME,	"IP_RET_TIME",	"低电压穿越恢复,维持上述电流时间(周,缺省0)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_WGWGEN_IP_RATE,		"IP_RATE",		"低电压穿越恢复,有功电流上升速率(A/s,缺省1500)",		MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_WGWGEN_Q_RATE,		"Q_RATE",		"无功调整变化率(pu,电压降低倍数,额定电流基准,缺省0)",	MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_WGWGEN_IMAX,		"IMAX",			"最大电流限制(A)",										MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_WGWGEN_KEYNAME,		"KeyName",		"数据库主键",											MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_SHORTER,	0,	NULL,	},
	{	BPA_SWI_WGWGEN_BUSPTR,		"BusPtr",		"发电机母线索引",										MDBFieldCategoryAid,	MDB_INT,	sizeof(int),			0,	NULL,	},
};

static	tagMemDBField	dicFieldBpaSwi_PV[]=
{
	{	BPA_SWI_PV_CARDKEY,		"CardKey",		"卡类型",										MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_SHORTEST,	0,	NULL,	},
	{	BPA_SWI_PV_BUS_NAME,	"ACBus_Name",	"电机母线名",									MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_BPABUS,		0,	NULL,	},
	{	BPA_SWI_PV_BUS_KV,		"ACBus_kV",		"电机母线电压(kV)",								MDBFieldCategoryBase,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_PV_ID,			"Gen_ID",		"电机识别码",									MDBFieldCategoryBase,	MDB_CHAR,	sizeof(char),			0,	NULL,	},
	{	BPA_SWI_PV_T,			"T",			"实际温度(℃)",									MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_PV_S,			"S",			"光照强度(W/m1)",								MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_PV_UOC,			"Uoc",			"单体电池标准条件下的开路电压(V)",				MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_PV_ISC,			"Isc",			"单体电池标准条件下的短路电流(A)",				MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_PV_UM,			"Um",			"单体电池标准条件下的最大功率点电压(V)",		MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_PV_IM,			"Im",			"单体电池标准条件下的最大功率点电流(A)",		MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_PV_N1,			"N1",			"光伏阵列并联电池组数",							MDBFieldCategoryParam,	MDB_SHORT,	sizeof(short),			0,	NULL,	},
	{	BPA_SWI_PV_N2,			"N2",			"光伏阵列串联电池组数",							MDBFieldCategoryParam,	MDB_SHORT,	sizeof(short),			0,	NULL,	},
	{	BPA_SWI_PV_KEYNAME,		"KeyName",		"数据库主键",									MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_SHORTER,	0,	NULL,	},
	{	BPA_SWI_PV_BUSPTR,		"BusPtr",		"发电机母线索引",								MDBFieldCategoryAid,	MDB_INT,	sizeof(int),			0,	NULL,	},
};
...
static	tagMemDBField	dicFieldBpaSwi_LOHG[]=
{
	...
	{	BPA_SWI_LOHG_BUSI,			"LOHG_BusI",		"母线名称1",							MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_BPABUS,		0,	NULL,	},
	{	BPA_SWI_LOHG_KVI,			"LOHG_kVI",			"基准电压1(kV)",						MDBFieldCategoryBase,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_LOHG_BUSJ,			"LOHG_BusJ",		"母线名称2",							MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_BPABUS,		0,	NULL,	},
	{	BPA_SWI_LOHG_KVJ,			"LOHG_kVJ",			"基准电压2(kV)",						MDBFieldCategoryBase,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_LOHG_LOOP,			"LOHG_Loop",		"并联线路的回路标志",					MDBFieldCategoryBase,	MDB_CHAR,	sizeof(char),			0,	NULL,	},
	{	BPA_SWI_LOHG_X0I,			"LOHG_X0I",			"线路前侧高抗对应的等值零序电抗(pu)",	MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_LOHG_X0J,			"LOHG_X0J",			"线路后侧高抗对应的等值零序电抗(pu)",	MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
...
static	tagMemDBField	dicFieldBpaSwi_D[]=
{
	...
	{	BPA_SWI_D_Tc,				"D_Tc",				"电流测量环节时间常数(秒)",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_D_Tv,				"D_Tv",				"电压测量环节时间常数(秒)",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_D_T1,				"D_T1",				"电流调节器时间常数1(秒)",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_D_T2,				"D_T2",				"电流调节器时间常数2(秒)",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_D_T3,				"D_T3",				"电流调节器时间常数3(秒)",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_D_Ka,				"D_Ka",				"电流调节器增益",								MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_D_MOD,				"D_MOD",			"控制方式,P＝定功率控制,I＝定电流控制",			MDBFieldCategoryParam,	MDB_CHAR,	sizeof(char),			0,	NULL,	},
	{	BPA_SWI_D_IMAX,				"D_IMAX",			"阀的过电流能力(pu)",							MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_D_IMARGIN,			"D_IMARGIN",		"电流余裕值(pu),逆变侧必须在0.05-0.3之间",		MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_D_ALPHASTOP,		"D_ALPHASTOP",		"作逆变器使用时的最小点燃角(度)",				MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_D_TD,				"D_TD",				"换相电压时间常数(秒),缺省0.01秒",				MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_D_VLIM,				"D_VLIM",			"电流限制起始处的额定端电压(pu),缺省0.25pu",	MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_D_DISA,				"D_DISA",			"非空则消去该直流控制系统",						MDBFieldCategoryParam,	MDB_CHAR,	sizeof(char),			0,	NULL,	},
	{	BPA_SWI_D_MSU,				"D_MSU",			"余裕开关单元关键码",							MDBFieldCategoryParam,	MDB_CHAR,	sizeof(char),			0,	NULL,	},
...
{
	{	BPA_SWI_DT_CARDKEY,			"CardKey",			"卡类型",										MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_SHORTEST,	0,	NULL,	},
	{	BPA_SWI_DT_BUS_NAME,		"DCBus_Name",		"直流母线名称",									MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_BPABUS,		0,	NULL,	},
	{	BPA_SWI_DT_BUS_KV,			"DCBus_KV",			"直流母线基准电压(kV)",							MDBFieldCategoryBase,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DT_DV,				"DT_DV",			"过载截断电压值(标么值)",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DT_IMAX,			"DT_IMAX",			"过电流能力(标么值)",							MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DT_IMARGIN,			"DT_IMARG",			"电流余裕值(标么值)",							MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DT_TC,				"DT_Tc",			"电流测量回路时间常数(秒)",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DT_TV,				"DT_Tv",			"电压测量回路时间常数(秒)",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DT_ALPHASTOP,		"DT_AlphaStop",		"逆变器最小点燃角",								MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DT_MSU,				"DT_MSU",			"余裕开关单元关键码",							MDBFieldCategoryParam,	MDB_CHAR,	sizeof(char),			0,	NULL,	},
	{	BPA_SWI_DT_KEYNAME,			"KeyName",			"数据库主键",									MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_SHORTER,	0,	NULL,	},
	{	BPA_SWI_DT_BUSPTR,			"BusPtr",			"直流母线索引",									MDBFieldCategoryAid,	MDB_INT,	sizeof(int),			0,	NULL,	},
};

static	tagMemDBField	dicFieldBpaSwi_DF[]=
{
	{	BPA_SWI_DF_CARDKEY,			"CardKey",			"卡类型",										MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_SHORTEST,	0,	NULL,	},
	{	BPA_SWI_DF_BUS_NAME,		"DCBus_Name",		"直流母线名称",									MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_BPABUS,		0,	NULL,	},
	{	BPA_SWI_DF_BUS_KV,			"DCBus_KV",			"直流母线基准电压(kV)",							MDBFieldCategoryBase,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DF_DVDT,			"DF_DVDT",			"直流系统可能发生换相失败的电压变化率的门槛值",	MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DF_VF1,				"DF_Vf1",			"直流系统可能发生换相失败的电压的门槛值",		MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DF_VF2,				"DF_Vf2",			"直流系统可能发生换相失败的电压的门槛值",		MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DF_DT,				"DF_DT",			"换相失败发生到直流系统闭锁的时间",				MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DF_VRS,				"DF_Vrs",			"直流系统恢复换相的电压的门槛值",				MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DF_C1,				"DF_C1",			"从恢复换相到T1时刻(秒)直流功率恢复的百分数",	MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DF_T1,				"DF_T1",			"T1时间",										MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DF_C2,				"DF_C2",			"从恢复换相到T2时刻(秒)直流功率恢复的百分数",	MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DF_T2,				"DF_T2",			"T2时间",										MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DF_C3,				"DF_C3",			"从恢复换相到T3时刻(秒)直流功率恢复的百分数",	MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DF_T3,				"DF_T3",			"T3时间",										MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DF_KEYNAME,			"KeyName",			"数据库主键",									MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_SHORTER,	0,	NULL,	},
	{	BPA_SWI_DF_BUSPTR,			"BusPtr",			"直流母线索引",									MDBFieldCategoryAid,	MDB_INT,	sizeof(int),			0,	NULL,	},
};

static	tagMemDBField	dicFieldBpaSwi_DM[]=
{
	{	BPA_SWI_DM_CARDKEY,			"CardKey",			"卡类型",												MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_SHORTEST,	0,	NULL,	},
	{	BPA_SWI_DM_BUS_NAME,		"DCBus_Name",		"直流母线名称",											MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_BPABUS,		0,	NULL,	},
	{	BPA_SWI_DM_BUS_KV,			"DCBus_KV",			"直流母线基准电压(kV)",									MDBFieldCategoryBase,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DM_MOD,				"DM_MOD",			"MOD,P=恒功率控制,I=恒电流控制",						MDBFieldCategoryParam,	MDB_CHAR,	sizeof(char),			0,	NULL,	},
	{	BPA_SWI_DM_TVP,				"DM_Tvp",			"整流侧功率定值环节中直流电压测量环节时间常数(秒)",		MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DM_IMAX,			"DM_IMAX",			"阀的过电流能力(标么值,整流侧填写)",					MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DM_IMIN,			"DM_IMIN",			"阀的最小电流(标么值,整流侧填写)",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DM_TIDMES,			"DM_Tidmes",		"直流电流测量环节时间常数(秒)",							MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DM_KP_I,			"DM_Kp_I",			"定电流调节器的比例增益",								MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DM_TI_I,			"DM_Ti_I",			"定电流调节器的积分时间常数(秒)",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DM_MAX_I,			"DM_Max_I",			"定电流调节器的输出上限(度)",							MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DM_MIN_I,			"DM_Min_I",			"定电流调节器的输出下限(度)",							MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DM_TGAMMES,			"DM_TGamMes",		"逆变侧γ测量环节时间常数(秒)",							MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DM_KP_GAM,			"DM_Kp_Gam",		"逆变侧定γ调节器的比例增益",							MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DM_TI_GAM,			"DM_Ti_Gam",		"逆变侧定γ调节器的积分时间常数(秒)",					MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DM_MAX_GAM,			"DM_Max_Gam",		"逆变侧定γ调节器的输出上限(度)",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DM_MIN_GAM,			"DM_Min_Gam",		"逆变侧定γ调节器的输出上限(度)",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DM_TVPSMPALL,		"DM_TvpSmpall",		"整流侧功率定值环节中直流电压测量环节小时间常数(秒)",	MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DM_DISA,			"DM_DISA",			"非空则消去该直流控制系统",								MDBFieldCategoryParam,	MDB_CHAR,	sizeof(char),			0,	NULL,	},

	{	BPA_SWI_DM_TVDCOL,			"DM_TVDCOL",		"VDCOL环节电压测量环节时间常数(秒,逆变侧填写)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DM_X1,				"DM_X1",			"VDCOL的x1(标么值,逆变侧填写)",							MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DM_Y1,				"DM_Y1",			"VDCOL的y1(标么值,逆变侧填写)",							MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DM_X2,				"DM_X2",			"VDCOL的x2(标么值,逆变侧填写)",							MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DM_Y2,				"DM_Y2",			"VDCOL的y2(标么值,逆变侧填写)",							MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DM_K1,				"DM_K1",			"VDCOL的斜率1(标么值,逆变侧填写)",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DM_K2,				"DM_K2",			"VDCOL的斜率2(标么值,逆变侧填写)",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DM_DOWNSL,			"DM_DownSL",		"VDCOL输出值的下降速率限制(pu/sec.,逆变侧填写)",		MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DM_UPSL,			"DM_UpSL",			"VDCOL输出值的上升速率限制(值大于零,pu/sec.,逆变侧填写)",	MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DM_GAMMAMIN,		"DM_GammaMin",		"逆变器换相失败的门槛值(度,逆变侧填写)",				MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DM_IMARGIN,			"DM_Imargin",		"电流裕度(标么值,逆变侧填写)",							MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DM_DGAMMIN,			"DM_DGamMin",		"逆变侧γ角的最大偏差限制(度,逆变侧填写)",				MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},

	{	BPA_SWI_DM_KEYNAME,			"KeyName",			"数据库主键",											MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_SHORTER,	0,	NULL,	},
	{	BPA_SWI_DM_BUSPTR,			"BusPtr",			"直流母线索引",											MDBFieldCategoryAid,	MDB_INT,	sizeof(int),			0,	NULL,	},
};

static	tagMemDBField	dicFieldBpaSwi_DN[]=
{
	{	BPA_SWI_DN_CARDKEY,			"CardKey",			"卡类型",												MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_SHORTEST,	0,	NULL,	},
	{	BPA_SWI_DN_BUS_NAME,		"DCBus_Name",		"直流母线名称",											MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_BPABUS,		0,	NULL,	},
	{	BPA_SWI_DN_BUS_KV,			"DCBus_KV",			"直流母线基准电压(kV)",									MDBFieldCategoryBase,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DN_MOD,				"DN_MOD",			"MOD,P=恒功率控制,I=恒电流控制",						MDBFieldCategoryParam,	MDB_CHAR,	sizeof(char),			0,	NULL,	},
	{	BPA_SWI_DN_TVP,				"DN_Tvp",			"整流侧功率定值环节中直流电压测量环节时间常数(秒)",		MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DN_IMAX,			"DN_IMAX",			"系统的暂时过电流能力(标么值,整流侧填写)",				MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DN_IMIN,			"DN_IMIN",			"系统的最小电流(标么值,整流侧填写)",					MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DN_P_I,				"DN_P_I",			"定电流调节器的比例增益",								MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DN_T_I,				"DN_T_I",			"定电流调节器的积分时间常数(秒)",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DN_P_U,				"DN_P_U",			"定电压调节器的比例增益",								MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DN_T_U,				"DN_T_U",			"定电压调节器的积分时间常数(秒)",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DN_P_GAM,			"DN_P_Gam",			"逆变侧定γ调节器的比例增益(逆变侧填写)",				MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DN_T_GAM,			"DN_T_Gam",			"逆变侧定γ调节器的积分时间常数(秒,逆变侧填写)",		MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DN_VACLOW,			"DN_VacLow",		"限幅回路中交流电压门槛值(标么值)",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DN_TVACLOW,			"DN_TVacLow",		"限幅回路中交流电压的延迟时间(秒)",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DN_IDLOW,			"DN_IdLow",			"限幅回路中直流电流门槛值(标么值)",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DN_TIDLOW,			"DN_TIdLow",		"限幅回路中直流电流的延迟时间(秒)",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DN_TLIM,			"DN_Tlim",			"限幅回路中时间常数(秒)",								MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DN_TP,				"DN_Tp",			"比例增益计算回路中时间常数(秒)",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DN_IOVL,			"DN_Iovl",			"直流系统短期过电流能力(标么值,整流侧填写)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DN_TIMAX,			"DN_Timax",			"直流系统暂时过电流的容许时间(秒,整流侧填写)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DN_TMAXLIM,			"DN_Tmaxlim",		"超过暂时过电流的容许时间后,电流定值由Imax下降到Iovl的时间(秒,整流侧填写)",	MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DN_DISA,			"DN_DISA",			"如果非空且非字符'F',则消去该直流控制系统(作为分区负荷)",					MDBFieldCategoryParam,	MDB_CHAR,	sizeof(char),			0,	NULL,	},

	{	BPA_SWI_DN_TVDCOL,			"DN_TVDCOL",		"VDCOL环节电压测量环节时间常数(秒,逆变侧填写)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DN_X1,				"DN_X1",			"VDCOL的x1(标么值,逆变侧填写)",							MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DN_Y1,				"DN_Y1",			"VDCOL的y1(标么值,逆变侧填写)",							MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DN_X2,				"DN_X2",			"VDCOL的x2(标么值,逆变侧填写)",							MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DN_Y2,				"DN_Y2",			"VDCOL的y2(标么值,逆变侧填写)",							MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DN_K1,				"DN_K1",			"VDCOL的斜率1(标么值,逆变侧填写)",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DN_K2,				"DN_K2",			"VDCOL的斜率2(标么值,逆变侧填写)",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DN_DOWNSL,			"DN_DownSL",		"VDCOL输出值的下降速率限制(pu/sec.,逆变侧填写)",		MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DN_UPSL,			"DN_UpSL",			"VDCOL输出值的上升速率限制(值大于零,pu/sec.,逆变侧填写)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DN_ALPHASTOP,		"DN_AlphaStop",		"作逆变器使用时的最小点燃角(度) ",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DN_GAMAAMIN,		"DN_GamaaMin",		"逆变器换相失败的门槛值(度)",							MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DN_TVPSMALL,		"DN_TvpSmall",		"整流侧功率定值环节中直流电压测量环节的小时间常数(秒,整流侧填写)",	MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},

	{	BPA_SWI_DN_KEYNAME,			"KeyName",			"数据库主键",											MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_SHORTER,	0,	NULL,	},
	{	BPA_SWI_DN_BUSPTR,			"BusPtr",			"直流母线索引",											MDBFieldCategoryAid,	MDB_INT,	sizeof(int),			0,	NULL,	},
};


static	tagMemDBField	dicFieldBpaSwi_DA[]=
{
	{	BPA_SWI_DA_CARDKEY,			"CardKey",			"卡类型",								MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_SHORTEST,	0,	NULL,	},
	{	BPA_SWI_DA_BUS_NAME,		"DCBus_Name",		"直流母线名称",							MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_BPABUS,		0,	NULL,	},
	{	BPA_SWI_DA_BUS_KV,			"DCBus_KV",			"直流母线基准电压(kV)",					MDBFieldCategoryBase,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DA_G_AMAX,			"DA_G_Amax",		"最大触发角控制增益",					MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DA_T_AMAX,			"DA_T_Amax",		"最大触发角控制时间常数(秒)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DA_GAMMAREF,		"DA_GammaRef",		"熄弧角参考值",							MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DA_GAMMAMIN,		"DA_GammaMin",		"熄弧角最小值",							MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DA_KP_VCA,			"DA_Kp_vca",		"定电压控制比例增益",					MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DA_TI_VCA,			"DA_Ti_vca",		"定电压控制积分时间常数(秒)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DA_K1_RA,			"DA_K1_ra",			"整流侧最小触发角控制增益1",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DA_K2_RA,			"DA_K2_ra",			"整流侧最小触发角控制增益2",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DA_CDL,				"DA_Cdl",			"整流侧最小触发角控制电压阈值1",		MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DA_D1,				"DA_D1",			"整流侧最小触发角控制电压阈值2",		MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DA_DECR,			"DA_Decr",			"整流侧最小触发角控制角度下降速率",		MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DA_T_GA,			"DA_T_ga",			"逆变侧Gamma0启动延时时间(秒)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DA_TD_RET,			"DA_Td_ret",		"直流重启动控制移相延时时间(秒)",		MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DA_TH_RET,			"DA_Th_ret",		"直流重启动控制移相持续时间(秒)",		MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DA_TH_RES,			"DA_Th_res",		"直流重启动控制重启指令延时时间(秒)",	MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DA_DISA,			"DA_DISA",			"非空则消去该直流控制系统",				MDBFieldCategoryParam,	MDB_CHAR,	sizeof(char),			0,	NULL,	},
	{	BPA_SWI_DA_DBG,				"DA_DBG",			"调试文件标志,非空则输出调试文件",		MDBFieldCategoryParam,	MDB_CHAR,	sizeof(char),			0,	NULL,	},

	{	BPA_SWI_DA_MOD,				"DA_MOD",			"控制方式,1=恒定功率,0=恒定电流",		MDBFieldCategoryParam,	MDB_STRING,	MDB_CHARLEN_SHORTEST,	0,	NULL,	},
	{	BPA_SWI_DA_LEAD,			"DA_LEAD",			"主控站,1=主控站,0=受控站",				MDBFieldCategoryParam,	MDB_STRING,	MDB_CHARLEN_SHORTEST,	0,	NULL,	},
	{	BPA_SWI_DA_OPN,				"DA_OPN",			"运行标志,1=运行状态,0=停运状态",		MDBFieldCategoryParam,	MDB_STRING,	MDB_CHARLEN_SHORTEST,	0,	NULL,	},
	{	BPA_SWI_DA_BC_ON,			"DA_BC_ON",			"协调控制标志,1=双极协调,0=独立运行",	MDBFieldCategoryParam,	MDB_STRING,	MDB_CHARLEN_SHORTEST,	0,	NULL,	},
	{	BPA_SWI_DA_UDLOW,			"DA_Udlow",			"VDCOL启动电压",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DA_UDHIGH,			"DA_Udhigh",		"VDCOL退出电压",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DA_UDTUP,			"DA_Udtup",			"VDCOL电压上升滤波时间常数",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DA_UDTDN,			"DA_Udtdn",			"VDCOL电压下降滤波时间常数",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DA_IOMIN_VDCL,		"DA_Iomin_vdcl",	"VDCOL最小插值电流指令",				MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DA_IOMIN,			"DA_Iomin",			"VDCOL最小电流指令",					MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DA_ID_T,			"DA_Id_t",			"定电流控制电流滤波时间常数(秒)",		MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DA_GAIN,			"DA_Gain",			"定电流控制总增益",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DA_KP,				"DA_Kp",			"定电流控制比例增益",					MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DA_TI,				"DA_Ti",			"定电流控制积分时间常数(秒)",			MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DA_G_CF,			"DA_G_cf",			"换相失败预测增益",						MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DA_K_CF,			"DA_K_cf",			"换相失败预测启动电压阈值",				MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DA_T_DN_CF,			"DA_T_dn_cf",		"换相失败预测输出角度下降时间常数(秒)",	MDBFieldCategoryParam,	MDB_FLOAT,	sizeof(float),			0,	NULL,	},
	{	BPA_SWI_DA_A,				"DA_A",				"DA卡续卡标志",							MDBFieldCategoryParam,	MDB_CHAR,	sizeof(char),			0,	NULL,	},

	{	BPA_SWI_DA_KEYNAME,			"KeyName",			"数据库主键",							MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_SHORTER,	0,	NULL,	},
	{	BPA_SWI_DA_BUSPTR,			"BusPtr",			"直流母线索引",							MDBFieldCategoryAid,	MDB_INT,	sizeof(int),			0,	NULL,	},
};
...
static	tagMemDBField	dicFieldBpaSwi_RE[]=
{
	...
	{	BPA_SWI_RE_KEYNAME,			"KeyName",			"数据库主键",			MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_SHORTER,	0,	NULL,	},
...
static	tagMemDBField	dicFieldBpaSwi_RW[]=
{
	...
	{	BPA_SWI_RW_KEYNAME,			"KeyName",			"数据库主键",								MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_SHORTER,	0,	NULL,	},
...
static	tagMemDBField	dicFieldBpaSwi_RA[]=
{
	...
	{	BPA_SWI_RA_KEYNAME,			"KeyName",			"线路名称",									MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_SHORT,		0,	NULL,	},
};
...
static	tagMemDBField	dicFieldBpaSwi_RU[]=
{
	...
	{	BPA_SWI_RU_KEYNAME,			"KeyName",			"线路名称",									MDBFieldCategoryBase,	MDB_STRING,	MDB_CHARLEN_SHORT,		0,	NULL,	},
};
