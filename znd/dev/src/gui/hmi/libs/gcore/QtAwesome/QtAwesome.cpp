...
*/
    ...
    setDefaultOption( "color-disabled", QColor(70,70,70,60));
    setDefaultOption( "color-active", QColor(10,10,10));
    setDefaultOption( "color-selected", QColor("#e25a59"));
    setDefaultOption( "scale-factor", 0.6 );
...
void QtAwesome::setOption(   const QVariant& args  )
{
    QJsonObject obj;
    ...
    if(!obj["color"].isUndefined()) defaultOptions_.insert( "color", QColor(obj["color"].toString()) );
    if(!obj["color-disabled"].isUndefined()) defaultOptions_.insert( "color-disabled", QColor(obj["color-disabled"].toString()) );
    if(!obj["color-active"].isUndefined()) defaultOptions_.insert( "color-active", QColor(obj["color-active"].toString()) );
    if(!obj["color-selected"].isUndefined()) defaultOptions_.insert( "color-selected", QColor(obj["color-selected"].toString()) );
    if(!obj["scale-factor"].isUndefined()) defaultOptions_.insert( "scale-factor",  obj["scale-factor"].toDouble() );
