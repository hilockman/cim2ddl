...
GlowShadowEffect::GlowShadowEffect(QObject *parent) :QGraphicsEffect(parent),
_distance(4.0f),
_blurRadius(10.0f),
_color(0, 0, 0, 80)
{
...
void GlowShadowEffect::draw(QPainter* painter)
{
...
QRectF GlowShadowEffect::boundingRectFor(const QRectF& rect) const
{
