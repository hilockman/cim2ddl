...
public:
    ...
    virtual void revert(QPainter *p, QSvgExtraStates &states);
    virtual Type type() const;
	qreal GetOpacity(){ return m_opacity; }
private:
    qreal m_opacity;
    qreal m_oldOpacity;
};
...
public:
    ...
    void setSize(qreal size)
    {
       ...
       // m_qfont.setPixelSize((int)size);
		m_qfont.setPointSizeF((qreal)(size / 1.6));//svg use PixelSize,hmi use pointSize
	...
	Qt::Alignment GetAnchor(){ return m_textAnchor; };
