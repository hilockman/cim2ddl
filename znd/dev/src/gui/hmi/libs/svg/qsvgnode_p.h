...
public:
	...
	QString nodeTag() const{ return m_nodeTag; }
	void setNodeTag(const QString &i){ m_nodeTag = i; }

    QString xmlClass() const;
    void setXmlClass(const QString &str);

	void setExtendedAttributes(QVariantMap extendedAttributes);
	QVariantMap extendedAttributes();
    QVariant extendedAttribute(QString name );
	void addExtendedAttribute(QString name, QVariant value);
protected:
