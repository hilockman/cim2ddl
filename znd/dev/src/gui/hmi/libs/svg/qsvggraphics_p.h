...
public:
	...
	QRect  GetBounds(){ return m_bounds; }
private:
    QImage m_image;
    QRect  m_bounds;
};
...
public:
    ...
    virtual Type type() const;
    virtual QRectF bounds(QPainter *p, QSvgExtraStates &states) const;
	QPolygonF GetPolygon(){ return m_poly; }
private:
    QPolygonF m_poly;
};
...
public:
	...
	QVector<QSvgTspan *> GetTspans(){ return m_tspans; }
...
public:
    ...
    virtual Type type() const;
    virtual QRectF bounds(QPainter *p, QSvgExtraStates &states) const;
	QSvgNode* GetLinkNode(){ return m_link; }
	QPointF   GetStartPoint(){ return m_start; }
private:
    QSvgNode *m_link;
    QPointF   m_start;
};
