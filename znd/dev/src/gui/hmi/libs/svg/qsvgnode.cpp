...
void QSvgNode::setExtendedAttributes(QVariantMap extendedAttributes)
{
	m_extendedAttributes = extendedAttributes;
}

QVariantMap QSvgNode::extendedAttributes()
{
	return m_extendedAttributes;
}

void QSvgNode::addExtendedAttribute(QString name, QVariant value)
{
	m_extendedAttributes[name] = value;
}

QVariant QSvgNode::extendedAttribute(QString name )
{
    return m_extendedAttributes[name] ;
}
