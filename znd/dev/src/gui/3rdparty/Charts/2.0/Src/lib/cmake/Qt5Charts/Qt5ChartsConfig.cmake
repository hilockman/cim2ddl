...
set(Qt5Charts_VERSION_STRING 2.0.0)
...
if (NOT TARGET Qt5::Charts)
    ...
    set(Qt5Charts_PRIVATE_INCLUDE_DIRS
        "${_qt5Charts_install_prefix}/include/QtCharts/2.0.0"
        "${_qt5Charts_install_prefix}/include/QtCharts/2.0.0/QtCharts"
    )
    ...
    foreach(_module_dep ${_Qt5Charts_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                2.0.0 ${_Qt5Charts_FIND_VERSION_EXACT}
