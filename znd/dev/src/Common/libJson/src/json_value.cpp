...
# ifndef JSON_VALUE_USE_INTERNAL_MAP
	...
	Value::CZString::CZString( int index ) : cstr_( 0 )
		, index_( index )
	{
	}
...
# ifdef JSON_VALUE_USE_INTERNAL_MAP
	...
	Value::Value( const StaticString &value ) : type_( stringValue )
		, allocated_( false )
		, comments_( 0 )
# ifdef JSON_VALUE_USE_INTERNAL_MAP
		, itemIsUsed_( 0 )
...
# ifdef JSON_USE_CPPTL
	Value::Value( const CppTL::ConstString &value ) : type_( stringValue )
		, allocated_( true )
		, comments_( 0 )
# ifdef JSON_VALUE_USE_INTERNAL_MAP
		, itemIsUsed_( 0 )
