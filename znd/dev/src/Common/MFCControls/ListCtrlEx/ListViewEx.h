#ifndef __LISTVIEWEX__
#define __LISTVIEWEX__
...
// operations
	public:
		...
		int					GetColumnCount() { return GetListCtrl().GetHeaderCtrl()->GetItemCount(); }
		int					GetRowCount() { return GetListCtrl().GetItemCount(); }
