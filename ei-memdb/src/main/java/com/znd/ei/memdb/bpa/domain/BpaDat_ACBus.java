...
public class BpaDat_ACBus  implements MemIndexable 
{
  ...
  //Ini延续节点有功负荷(MW)
  private Double ACBus_IniAddPLoad;
  
  //Ini延续节点无功负荷(MVAR),+感性
  private Double ACBus_IniAddQLoad;
  
  //Ini延续节点并联有功负荷(MW)
  private Double ACBus_IniAddPShunt;
  
  //Ini延续节点并联无功负荷(MVAR),+容性
  private Double ACBus_IniAddQShunt;
  
  //Ini延续节点有功出力(MW)
  private Double ACBus_IniAddPGen;
  
  //Ini延续节点无功出力(MVAR),+感性
  private Double ACBus_IniAddQGen;
  ...
  public Double getACBus_IniAddPLoad()
  {
    return ACBus_IniAddPLoad;
  }
    
  public void setACBus_IniAddPLoad(Double ACBus_IniAddPLoad)
  {
    this.ACBus_IniAddPLoad = ACBus_IniAddPLoad;
  }
    
  public Double getACBus_IniAddQLoad()
  {
    return ACBus_IniAddQLoad;
  }
    
  public void setACBus_IniAddQLoad(Double ACBus_IniAddQLoad)
  {
    this.ACBus_IniAddQLoad = ACBus_IniAddQLoad;
  }
    
  public Double getACBus_IniAddPShunt()
  {
    return ACBus_IniAddPShunt;
  }
    
  public void setACBus_IniAddPShunt(Double ACBus_IniAddPShunt)
  {
    this.ACBus_IniAddPShunt = ACBus_IniAddPShunt;
  }
    
  public Double getACBus_IniAddQShunt()
  {
    return ACBus_IniAddQShunt;
  }
    
  public void setACBus_IniAddQShunt(Double ACBus_IniAddQShunt)
  {
    this.ACBus_IniAddQShunt = ACBus_IniAddQShunt;
  }
    
  public Double getACBus_IniAddPGen()
  {
    return ACBus_IniAddPGen;
  }
    
  public void setACBus_IniAddPGen(Double ACBus_IniAddPGen)
  {
    this.ACBus_IniAddPGen = ACBus_IniAddPGen;
  }
    
  public Double getACBus_IniAddQGen()
  {
    return ACBus_IniAddQGen;
  }
    
  public void setACBus_IniAddQGen(Double ACBus_IniAddQGen)
  {
    this.ACBus_IniAddQGen = ACBus_IniAddQGen;
  }
  ...
  public String toString()
  {
    return "BpaDat_ACBus ["+"id = " + id
	 ...
	 + ", ACBus_IniAddPLoad = " + ACBus_IniAddPLoad
	 + ", ACBus_IniAddQLoad = " + ACBus_IniAddQLoad
	 + ", ACBus_IniAddPShunt = " + ACBus_IniAddPShunt
	 + ", ACBus_IniAddQShunt = " + ACBus_IniAddQShunt
	 + ", ACBus_IniAddPGen = " + ACBus_IniAddPGen
	 + ", ACBus_IniAddQGen = " + ACBus_IniAddQGen
	 + ", TMid = " + TMid
	 + ", Generator = " + Generator
	 + ", WTGen = " + WTGen
	 + ", PVGen = " + PVGen
