...
*区域表(AREA)	*
***********************/
public class BpaDat_Area  implements MemIndexable 
{
  private Integer id;
  ...
  //区域缓冲节点名称
  private String SlackBusName;
  
  //区域缓冲节点基准电压
  private Double SlackBuskV;
  ...
  public void setSlackBusName(String SlackBusName)
  {
  ...
  public void setSlackBuskV(Double SlackBuskV)
  {
  ...
  public void setOutP(Double OutP)
  {
    this.OutP = OutP;
  }
