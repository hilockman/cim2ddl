...
public class Substation  implements MemIndexable 
{
  ...
  //电力电子变压器范围
  private Integer ElectronicTransformerRange;
  ...
  public Integer getElectronicTransformerRange()
  {
    return ElectronicTransformerRange;
  }
    
  public void setElectronicTransformerRange(Integer ElectronicTransformerRange)
  {
    this.ElectronicTransformerRange = ElectronicTransformerRange;
  }
  ...
  public String toString()
  {
    return "Substation ["+"id = " + id
	 ...
	 + ", ElectronicTransformerRange = " + ElectronicTransformerRange
