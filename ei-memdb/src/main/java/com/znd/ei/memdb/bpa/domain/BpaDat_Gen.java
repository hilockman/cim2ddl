...
public class BpaDat_Gen  implements MemIndexable 
{
  ...
  //风电机组
  private Integer Gen_WTGen;
  
  //光伏模型
  private Integer Gen_PVGen;
  ...
  public Integer getGen_WTGen()
  {
    return Gen_WTGen;
  }
    
  public void setGen_WTGen(Integer Gen_WTGen)
  {
    this.Gen_WTGen = Gen_WTGen;
  }
    
  public Integer getGen_PVGen()
  {
    return Gen_PVGen;
  }
    
  public void setGen_PVGen(Integer Gen_PVGen)
  {
    this.Gen_PVGen = Gen_PVGen;
  }
