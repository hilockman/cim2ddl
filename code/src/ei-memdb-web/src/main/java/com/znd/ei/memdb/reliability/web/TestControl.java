...
public class TestControl {
	...
	public void test() {
		...
		System.out.println("FState :\n" + Utils.toString(result.getState()));


		
		findByIndex(fStateFDevDao, result.getDevs(), state_index, (FStateFDev o)-> { return o.getFState();});
		findByIndex(mIslandDao, result.getMislands(), state_index, (FStateMIsland o)-> { return o.getFState();});
		findByIndex(ovlAdDao, result.getOvlAds(), state_index, (FStateOvlAd o)-> { return o.getFState();});
		findByIndex(ovlDevDao, result.getOvlDevs(), state_index, (FStateOvlDev o)-> { return o.getFState();});
