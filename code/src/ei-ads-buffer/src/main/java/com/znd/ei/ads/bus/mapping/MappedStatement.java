...
import com.znd.ei.ads.bus.statement.DeleteStatementHandler;
	  ...
	  public static class Build {
		  ...
		  private void addParameter(String argName, Class<?> argType) {
			  ...
			  if (typeHandler != null) {
				  ...
				  ParameterMapping parameterMapping = new ParameterMapping(argName, column.getType(),column.getIndex(), column.getDbIndex(), typeHandler, column.isIndexable());
