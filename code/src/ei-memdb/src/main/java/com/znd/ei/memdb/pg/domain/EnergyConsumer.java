...
public class EnergyConsumer  implements MemIndexable 
{
  ...
  //年均切换停电次数(次/年)
  private Double ro_swr;
  
  //切换停电平均持续时间(小时/次)
  private Double ro_swt;
  
  //年均切换停电时间(小时/年)
  private Double ro_swu;
  ...
  public Double getro_swr()
  {
    return ro_swr;
  }
    
  public void setro_swr(Double ro_swr)
  {
    this.ro_swr = ro_swr;
  }
    
  public Double getro_swt()
  {
    return ro_swt;
  }
    
  public void setro_swt(Double ro_swt)
  {
    this.ro_swt = ro_swt;
  }
    
  public Double getro_swu()
  {
    return ro_swu;
  }
    
  public void setro_swu(Double ro_swu)
  {
    this.ro_swu = ro_swu;
  }
