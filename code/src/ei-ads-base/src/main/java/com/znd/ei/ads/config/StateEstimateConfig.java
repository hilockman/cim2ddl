...
public class StateEstimateConfig {
	...
	public String toString() {
		return "StateEstimateConfig [dc2AcFactor=" + dc2AcFactor
				+ ", lineELimit=" + lineELimit + ", tranELimit=" + tranELimit
				+ ", genPELimit=" + genPELimit + ", uPFCELimit=" + uPFCELimit
				+ ", auxLoadAdjust=" + auxLoadAdjust + ", eQGenAdjust="
				+ eQGenAdjust + ", eQLoadAdjust=" + eQLoadAdjust
				+ ", minIslandGLRatio=" + minIslandGLRatio + ", uPFCAdjustRC="
				+ uPFCAdjustRC + "]";
	}
}
