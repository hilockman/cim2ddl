...
public String toString() {
	return "ACBus [name=" + name + ", kV=" + kV + ", zone=" + zone + ", genP="
			+ genP + ", genQ=" + genQ + ", loadP=" + loadP + ", loadQ=" + loadQ
			+ ", radP=" + radP + ", shuntQ=" + shuntQ + ", rerr=" + rerr
			+ ", rrep=" + rrep + ", trep=" + trep + ", adGenP=" + adGenP
			+ ", adLoadP=" + adLoadP + ", adRadP=" + adRadP + ", goodProb="
			+ goodProb + ", failProb=" + failProb + ", iRt=" + iRt + ", iMax="
			+ iMax + ", iMin=" + iMin + ", rerrMax=" + rerrMax + ", rerrMin="
			+ rerrMin + ", rtV=" + rtV + ", pfD=" + pfD + ", pLC=" + pLC
			+ ", eFLC=" + eFLC + ", eDLC=" + eDLC + ", aDLC=" + aDLC + ", eLC="
			+ eLC + ", eENS=" + eENS + ", bPECI=" + bPECI + ", bPII=" + bPII
			+ ", sI=" + sI + ", aCIsland=" + aCIsland + ", uVOLmtFreq="
			+ uVOLmtFreq + ", uFOLmtFreq=" + uFOLmtFreq + ", dVOLmtFreq="
			+ dVOLmtFreq + ", dFOLmtFreq=" + dFOLmtFreq + ", radial=" + radial
			+ ", slack=" + slack + ", srcBus=" + srcBus + ", midBus=" + midBus
			+ ", genPMax=" + genPMax + ", genPMin=" + genPMin + ", loadPMin="
			+ loadPMin + ", bus2Line=" + bus2Line + ", bus2Tran=" + bus2Tran
			+ ", zoneIndex=" + zoneIndex + ", ringBound=" + ringBound
			+ ", loadMState=" + loadMState + ", dCBus=" + dCBus
